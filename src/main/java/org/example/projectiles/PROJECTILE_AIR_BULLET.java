...
public class PROJECTILE_AIR_BULLET extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_AIR_BULLET(){
        ...
        this.projectileComponent.getDamageComponent().setDamage(5.75, DamageType.PROJECTILE);
    }
}
...
/*<Entity name="$projectile_default" tags="projectile_player" >
  ...
  <AudioComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/light_bullet_air.xml"
		>
	</VariableStorageComponent>
