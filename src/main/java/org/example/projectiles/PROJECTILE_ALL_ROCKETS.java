...
public class PROJECTILE_ALL_ROCKETS extends Projectile{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_ALL_ROCKETS(){
...
/*<Entity tags="projectile_player" >
	<LuaComponent
		script_source_file="data/scripts/projectiles/all_rockets.lua"
...
// data/scripts/projectiles/all_rockets.lua
