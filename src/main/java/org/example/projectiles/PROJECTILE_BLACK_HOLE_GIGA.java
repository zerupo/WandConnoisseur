...
public class PROJECTILE_BLACK_HOLE_GIGA extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_BLACK_HOLE_GIGA(){
...
/*<Entity tags="projectile_player,black_hole_giga,black_hole" >
	...
	<SpriteComponent
		...
		emissive="1"
		z_index="-1"
		image_file="data/projectiles_gfx/black_hole_giga.png"
		smooth_filtering="1"
	></SpriteComponent>
	...
	<AreaDamageComponent
		...
		death_cause="$action_black_hole_giga"
