...
public class PROJECTILE_BOMB_DETONATOR extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_BOMB_DETONATOR(){
...
/*<Entity
  ...
  <LuaComponent
	script_source_file="data/scripts/projectiles/bomb_detonator.lua"
