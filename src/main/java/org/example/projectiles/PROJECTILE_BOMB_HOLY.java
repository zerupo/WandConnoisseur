...
public class PROJECTILE_BOMB_HOLY extends ProjectileBasePhysics{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_BOMB_HOLY(){
        this.name = "Holy Bomb";
...
/*<Entity name="$projectile_default" >
  ...
  <Base file="data/entities/base_projectile_physics.xml">
    ...
    <PhysicsImageShapeComponent
      image_file="data/items_gfx/bomb_holy_giga.png"
      material="fuse_holy" >
    </PhysicsImageShapeComponent>
  ...
  <VariableStorageComponent
		...
		value_string="data/entities/projectiles/bomb_holy_giga.xml"
		>
	</VariableStorageComponent>
