...
public class PROJECTILE_DIGGER extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_DIGGER(){
        ...
        this.projectileComponent.getDamageComponent().setDamage(7.5, DamageType.DRILL);
    }
}
