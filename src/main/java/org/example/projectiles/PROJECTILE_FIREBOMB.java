...
public class PROJECTILE_FIREBOMB extends ProjectileBase{
    ...
    public PROJECTILE_FIREBOMB(){
        ...
        this.projectileComponent.getDamageComponent().setDamage(10.0, DamageType.FIRE);
    }
}
...
/*<Entity name="$projectile_default" tags="projectile_player" >
  ...
  <AudioComponent
      ...
      event_root="player_projectiles/bullet_fire_small">
  </AudioComponent>

	<VariableStorageComponent
		name="projectile_file"
		value_string="data/entities/projectiles/deck/firebomb.xml"
		>
	</VariableStorageComponent>
