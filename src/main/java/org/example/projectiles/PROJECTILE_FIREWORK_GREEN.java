...
public class PROJECTILE_FIREWORK_GREEN extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_FIREWORK_GREEN(){
        this.name = "Green Firework";
        this.imageFile = "fireworks_green.png";
...
/*<Entity name="$projectile_default">
  ...
  <ProjectileComponent
    ...
    <config_explosion
      ...
      load_this_entity="data/entities/particles/fireworks/firework_green.xml"
  ...
  <AudioComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/fireworks/firework_green.xml"
		>
	</VariableStorageComponent>
