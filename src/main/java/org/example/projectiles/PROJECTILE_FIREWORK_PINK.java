...
public class PROJECTILE_FIREWORK_PINK extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_FIREWORK_PINK(){
        this.name = "Pink Firework";
        this.imageFile = "fireworks_pink.png";
...
/*<Entity name="$projectile_default">
  ...
  <ProjectileComponent
    ...
    <config_explosion
      ...
      load_this_entity="data/entities/particles/fireworks/firework_pink.xml"
