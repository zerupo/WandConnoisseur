...
public class PROJECTILE_FRIEND_FLY extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_FRIEND_FLY(){
        ...
        this.projectileComponent.getDamageComponent().setDamage(10.0, DamageType.MELEE);
    }
}
