...
public class PROJECTILE_HOOK extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_HOOK(){
        this.name = "Hookbolt";
...
/*<Entity name="$projectile_default" tags="projectile_player" >
  ...
  <SpriteComponent
    _enabled="1"
    alpha="1"
    image_file="data/projectiles_gfx/hook.xml"
    next_rect_animation=""
    rect_animation=""
    additive="1"
    >
  ...
  <LightComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/hook.xml"
		>
	</VariableStorageComponent>

	 <LuaComponent
		script_source_file="data/scripts/projectiles/hook.lua"
		execute_on_removed="1"
		execute_every_n_frame="999999"
		>
	  </LuaComponent>
