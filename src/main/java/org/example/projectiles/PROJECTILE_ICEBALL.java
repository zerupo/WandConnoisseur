...
public class PROJECTILE_ICEBALL extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_ICEBALL(){
        this.name = "Iceball";
...
/*<Entity
  ...
  <SpriteComponent
    _enabled="1"
    alpha="1"
    image_file="data/projectiles_gfx/fireball_alt_ice.xml"
    next_rect_animation=""
    offset_x="16"
    offset_y="12"
    rect_animation=""
  ...
  <!-- NOTE( Petri ): 1.6.2023 - refactored the freezing to
   material_converter_freeze.xml . -->
  ...
  <AudioComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/iceball.xml"
		>
	</VariableStorageComponent>
