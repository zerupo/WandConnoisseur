...
public class PROJECTILE_METEOR_RAIN_METEOR extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_METEOR_RAIN_METEOR(){
        this.name = "Meteorisade meteor";
        this.imageFile = "meteor_rain_meteor.png";
...
/*<Entity
  name="$projectile_default" tags="projectile_player"
   >
	...
	<LuaComponent
		script_source_file="data/scripts/projectiles/meteor_collide.lua"
  ...
  <SpriteComponent
    _enabled="1"
    alpha="1"
    image_file="data/projectiles_gfx/meteor.xml"
    next_rect_animation=""
    offset_x="0"
    offset_y="0"
    rect_animation=""
  ...
  <AudioLoopComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/meteor.xml"
		>
	</VariableStorageComponent>
</Entity>*/