...
public class PROJECTILE_OCARINA_A2 extends Projectile{
    @Override
    protected void initialization(){
        this.name = "Ocarina - Note A2";
        this.emote = getEmoteConfig("ocarina_a2");
        this.gravityY = 0;
        this.airFriction = 8;
        this.mass = 0.01;
...
/*<Entity name="$projectile_default" tags="projectile_player" >
	...
	<SpriteParticleEmitterComponent
		...
		delay="0"
		lifetime="1.5"
		color.r="0.4" color.g="1" color.b="1" color.a="1"
	...
	<AudioComponent
		...
		event_root="player_projectiles/ocarina/a2"
