...
public class PROJECTILE_OCARINA_E extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_OCARINA_E(){
...
/*<Entity name="$projectile_default" tags="projectile_player" >
	...
	<SpriteParticleEmitterComponent
		...
		delay="0"
		lifetime="1.5"
		color.r="0.6" color.g="1" color.b="1" color.a="1"
	...
	<AudioComponent
		...
		event_root="player_projectiles/ocarina/e"
