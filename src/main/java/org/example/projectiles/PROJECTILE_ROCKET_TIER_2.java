...
public class PROJECTILE_ROCKET_TIER_2 extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_ROCKET_TIER_2(){
        ...
        this.projectileComponent.getDamageComponent().setDamage(100.0, DamageType.PROJECTILE);
    }
}
...
/*<Entity name="$projectile_default" tags="projectile_player,rocket" >
  ...
  <ProjectileComponent
    ...
    <config_explosion
      ...
      load_this_entity="data/entities/particles/particle_explosion/main_swirly_green.xml"
  ...
  <AudioComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/rocket_tier_2.xml"
		>
	</VariableStorageComponent>
