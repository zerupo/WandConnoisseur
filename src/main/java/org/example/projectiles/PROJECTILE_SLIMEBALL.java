...
public class PROJECTILE_SLIMEBALL extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_SLIMEBALL(){
        this.name = "Slimeball";
        ...
        this.projectileComponent.getDamageComponent().setDamage(6.25, DamageType.PROJECTILE);
    }
}
...
/*<Entity tags="hittable,projectile_player" name="$projectile_default">
  ...
  <AudioComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/slime.xml"
		>
	</VariableStorageComponent>
