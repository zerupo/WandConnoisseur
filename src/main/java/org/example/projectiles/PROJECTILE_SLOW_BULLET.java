...
public class PROJECTILE_SLOW_BULLET extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_SLOW_BULLET(){
        ...
        this.projectileComponent.getDamageComponent().setDamage(11.25, DamageType.PROJECTILE);
    }
}
...
/*<Entity name="$projectile_default" tags="projectile_player" >
  ...
  <AudioComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/bullet_slow.xml"
		>
	</VariableStorageComponent>
