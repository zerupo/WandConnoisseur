...
public class PROJECTILE_SUMMON_EGG_FIRE extends ProjectileBaseItem{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_SUMMON_EGG_FIRE(){
        this.name = "Summon egg fire";
        this.imageFile = "egg_red.png";
...
/*<Entity tags="hittable,teleportable_NOT,item_physics,egg_item,item_pickup" >
  ...
  <ExplodeOnDamageComponent
    ...
    <config_explosion
	  ...
	  load_this_entity="data/entities/projectiles/egg_fire.xml"
  ...
  <ItemComponent
    ...
    ui_description="$item_description_egg_fire"
