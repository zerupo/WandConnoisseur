...
public class PROJECTILE_SWARM_FIREBUG extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_SWARM_FIREBUG(){
        this.name = "Summon Firebug swarm";
        this.imageFile = "swarm_firebug_solo.png";
        ...
        this.projectileComponent.getDamageComponent().setDamage(3.75, DamageType.FIRE);
    }
}
...
/*<Entity
  ...
  <SpriteComponent
    _enabled="1"
    alpha="1"
    image_file="data/projectiles_gfx/swarm_firebug.xml"
    next_rect_animation=""
    rect_animation=""
     has_special_scale="1"
	 special_scale_x="1"
  ...
  <ParticleEmitterComponent
	...
	<DamageModelComponent
		...
		materials_that_damage="acid,water,poison,blood_cold,blood_cold_vapour,water_ice"
		materials_how_much_damage="0.004,0.05,0.001,0.08,0.07,0.01"
  ...
  <ParticleEmitterComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/swarm_firebug.xml"
		>
	</VariableStorageComponent>
