...
public class PROJECTILE_SWARM_WASP extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_SWARM_WASP(){
        this.name = "Summon Wasp swarm";
        this.imageFile = "swarm_wasp_solo.png";
        ...
        this.projectileComponent.getDamageComponent().setDamage(4.2, DamageType.MELEE);
    }
}
...
/*<Entity
  ...
  <SpriteComponent
    _enabled="1"
    alpha="1"
    image_file="data/projectiles_gfx/swarm_wasp.xml"
    next_rect_animation=""
    rect_animation=""
     has_special_scale="1"
	 special_scale_x="1"
  ...
  <ParticleEmitterComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/swarm_wasp.xml"
		>
	</VariableStorageComponent>
