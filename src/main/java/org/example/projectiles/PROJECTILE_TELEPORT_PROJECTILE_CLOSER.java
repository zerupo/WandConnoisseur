...
public class PROJECTILE_TELEPORT_PROJECTILE_CLOSER extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_TELEPORT_PROJECTILE_CLOSER(){
...
/*<Entity name="$projectile_default" tags="projectile_player,teleport_projectile_closer" >
  ...
  <ParticleEmitterComponent
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/teleport_projectile_closer.xml"
		>
	</VariableStorageComponent>

	<VariableStorageComponent
		_tags="teleport_closer"
		name="origin_x"
		value_float="0"
		>
	</VariableStorageComponent>
