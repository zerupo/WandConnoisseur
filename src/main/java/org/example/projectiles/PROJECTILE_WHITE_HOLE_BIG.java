...
public class PROJECTILE_WHITE_HOLE_BIG extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_WHITE_HOLE_BIG(){
...
/*<Entity name="$projectile_default" tags="projectile_player,black_hole">
  ...
  <BlackHoleComponent
	...
	<LuaComponent
		_enabled="1"
		script_source_file="data/scripts/projectiles/white_hole_big.lua"
