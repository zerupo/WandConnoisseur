...
public class PROJECTILE_WHITE_HOLE_GIGA extends ProjectileBase{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    public PROJECTILE_WHITE_HOLE_GIGA(){
...
/*<Entity tags="projectile_player,black_hole_giga,black_hole" >
	...
	<SpriteComponent
		...
		emissive="1"
		z_index="-1"
		image_file="data/projectiles_gfx/white_hole_giga.png"
		smooth_filtering="1"
	></SpriteComponent>
	...
	<VariableStorageComponent
		...
		value_string="data/entities/projectiles/deck/white_hole_giga.xml"
		>
	</VariableStorageComponent>
