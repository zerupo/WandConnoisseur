...
import org.example.script.SCRIPT_COLOUR_RAINBOW;
...
public class COLOUR_RAINBOW extends Spell{
    ...
    protected void initialization(){
        ...
        this.alias = new String[]{this.getClass().getSimpleName(), this.name, "rainbow", "glimmer"};
        this.imageFile = "colour_rainbow.png";
        this.emote = staticEmote;
        this.description = "Gives a projectile a randomly colored sparkly trail";
        this.type = SpellType.modifier;
        this.relatedScripts = new Script[]{new SCRIPT_COLOUR_RAINBOW()};
