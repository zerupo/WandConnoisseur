...
import org.example.script.SCRIPT_HITFX_CRITICAL_OIL;
...
public class HITFX_CRITICAL_OIL extends Spell{
    ...
    protected void initialization(){
        ...
        this.alias = new String[]{this.getClass().getSimpleName(), this.name, "crit on oil"};
        this.imageFile = "critical_oil.png";
        this.emote = staticEmote;
        this.description = "Makes a projectile always do a critical hit on oiled enemies";
        this.type = SpellType.modifier;
        this.relatedScripts = new Script[]{new SCRIPT_HITFX_CRITICAL_OIL()};
