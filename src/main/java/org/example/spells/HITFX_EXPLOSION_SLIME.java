...
import org.example.script.SCRIPT_HITFX_EXPLOSION_SLIME;
...
public class HITFX_EXPLOSION_SLIME extends Spell{
    ...
    protected void initialization(){
        ...
        this.alias = new String[]{this.getClass().getSimpleName(), this.name, "explosion on slimy", "explosion on slime"};
        ...
        this.relatedScripts = new Script[]{new SCRIPT_HITFX_EXPLOSION_SLIME()};
