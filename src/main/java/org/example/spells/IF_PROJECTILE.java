...
public class IF_PROJECTILE extends Spell{
    static String staticEmote = EmoteConfig.getEmote(MethodHandles.lookup().lookupClass().getSimpleName().toLowerCase());

    @Override
    protected void initialization(){
        this.name = "Requirement - Projectile Spells";
        this.alias = new String[]{this.getClass().getSimpleName(), this.name, "requirement projectile", "req proj", "if proj", "proj req"};
        this.imageFile = "if_projectile.png";
        this.emote = staticEmote;
        this.description = "The next spell is skipped if there are less than 20 projectiles nearby";
    ...
    public void action(CardPool cardPool, CastState castState, int recursionLevel, int iterationLevel){
        ...
        int envelope_min = 0;
        int envelope_max = 0;
        boolean skip = Global.getProjectileCount() < 20;
