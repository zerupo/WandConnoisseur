...
import org.example.projectiles.PROJECTILE_WHITE_HOLE_GIGA;
...
public class WHITE_HOLE_GIGA extends Spell{
    ...
    protected void initialization(){
        ...
        this.alias = new String[]{this.getClass().getSimpleName(), this.name, "omega wh"};
        ...
        this.relatedProjectile = new PROJECTILE_WHITE_HOLE_GIGA();
